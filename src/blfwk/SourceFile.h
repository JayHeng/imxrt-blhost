...
#if MCU_IOSTREAM_SUPPORT
#include "MCUiostream.h"
#endif
...
#if MCU_IOSTREAM_SUPPORT
    virtual bool isOpen() const {return 0;}
#else
...
#if MCU_IOSTREAM_SUPPORT
    smart_ptr<MCUistream> m_stream;	//!< File stream, or NULL if file is closed.
#else
...
#if MCU_IOSTREAM_SUPPORT
    inline MCUistream *getStream() {return m_stream;}
#else
